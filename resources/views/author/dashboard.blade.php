    ...
    <div class="bg-white">
        ...
        <div class="widget widget-tabbed">
            ...
            <ul class="nav nav-tabs tabs-alt justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link py-4" href="#adopt" data-toggle="tab"><i
                            class="material-icons">assignment_turned_in</i>Adopt</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('author.post.store') }}" method="POST"
                                                            ...
                                                            @csrf
                                                            <div class="header">
                                                                <label for="add">ADD NEW POST</label>
                                                                ...
                                                                <div class="form-group form-float">
                                                                    <div class="form-line">
                                                                        <textarea type="text" id="title"
                                                                            ...
                                                                            placeholder="Post Title" aria-required="true"
                                                    ...
                                                    <div class="card card-white grid-margin">
                                                        <div class="card-body">
                                                                                            ...
                                                                                            <div class="card">
                                                                                                ...
                                                                                                <div class="body">
                                                                                                    ...
                                                                                                    <a class="btn btn-danger m-t-15 waves-effect"
                                                                                                        href="{{ route('author.dashboard') }}">BACK</a>
                                                                                                    <button type="submit"
                                                                                                        class="btn btn-primary m-t-15 waves-effect">SUBMIT</button>
                                                                                                </div>
                                                                                            </div>
                                                            ...
                                                            <div class="timeline-item-post">
                                                                ...
                                                                <div class="blog-image1" style="width:700px; height:500px">
                        ...
                        <div class="col-lg-12 col-xl-7 center-block">
                            <div class="body">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link py-4 active" href="#profile" data-toggle="tab"><i
                                                class="material-icons">face</i> UPDATE PROFILE</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link py-4" href="#change_password" data-toggle="tab">
                                ...
                                <div class="col-sm-4">
                                    <div class="gal-detail thumb">
                                        <a href="#" class="image-popup" title="Screenshot-2">
                                            <img src="{{ asset('storage/post') }}/{{ $post->image }}" class="thumb-img"
                                                alt="work-thumbnail">
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="tab-pane animated fadeInRight" id="catowner">
                    <div class="user-profile-content">
                        <div class="block-header">
                            <a class="btn btn-primary waves-effect" href="{{ route('author.catowner.create') }}">
                ...
                <!-- Tab user Maps -->
                <div class="tab-pane animated fadeInRight" id="adopt">
                    <div class="user-profile-content">
                        {{-- <div class="block-header">
                            <a class="btn btn-primary waves-effect" href="{{ route('author.adopt.index') }}">
                                <i class="material-icons">assignment_turned_in</i>Adopt</a>
                        </div> --}}
                        <!-- Exportable Table -->
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="header">
                                        <h2>
                                            ALL Adopt
                                            {{-- <span class="badge bg-blue">{{ $cats->count() }}</span> --}}
                                        </h2>
                                    </div>
                                    {{-- <div class="body">
                                        <div class="table-responsive">
                                                    ...
                                                    @foreach ($catowners as $key => $catowner)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="{{ route('author.catowner.pending', $catowner->id) }}"
                                                                    class="btn btn-success waves-effect">
